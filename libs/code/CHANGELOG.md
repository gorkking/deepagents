...
## [0.1.67](https://github.com/gorkking/deepagents/compare/deepagents-code==0.1.66...deepagents-code==0.1.67) (2026-09-08)


### Features

* **code,evals:** inject goal/rubric context, dropping `get_goal`/`get_rubric` ([#5041](https://github.com/gorkking/deepagents/issues/5041)) ([2c80153](https://github.com/gorkking/deepagents/commit/2c801537885ea511c91fc880f6f8daa0a71342be))
* **code,talon:** require Python 3.12 or greater ([#5603](https://github.com/gorkking/deepagents/issues/5603)) ([04de43e](https://github.com/gorkking/deepagents/commit/04de43e05adcbd38f1022f1fafe93f6748c2a032))
* **code:** `/context-doctor` ([#5830](https://github.com/gorkking/deepagents/issues/5830)) ([80719ce](https://github.com/gorkking/deepagents/commit/80719ceee8d12060d7ffcdfff880777dc3aaf212))
* **code:** `Ctrl+S` in `/auto model` stores `[models].auto_classifier` ([#5313](https://github.com/gorkking/deepagents/issues/5313)) ([e742d04](https://github.com/gorkking/deepagents/commit/e742d04c8ca6f615327d7d1eab7994be8fcb3000))
* **code:** `managed_config.toml` ([#5604](https://github.com/gorkking/deepagents/issues/5604)) ([d419122](https://github.com/gorkking/deepagents/commit/d419122bfb748a823d1fa7cfd7207c428f4fbcab))
* **code:** add `/context` usage report ([#5407](https://github.com/gorkking/deepagents/issues/5407)) ([0355416](https://github.com/gorkking/deepagents/commit/0355416c0d4817ac58d3e14aa8b7ab099b6db74d))
* **code:** add `/summarization-model` ([#5884](https://github.com/gorkking/deepagents/issues/5884)) ([4f34c51](https://github.com/gorkking/deepagents/commit/4f34c51d4b9f6ed508af6a8e1ca6dbcf6e3e3877))
* **code:** add `DeepSeek-V4-Pro-0813` to model picker ([#5512](https://github.com/gorkking/deepagents/issues/5512)) ([f23d81b](https://github.com/gorkking/deepagents/commit/f23d81b910b7c3343fda293d70f0a75d44f45ba0))
* **code:** add `editable` trace metadata ([#5737](https://github.com/gorkking/deepagents/issues/5737)) ([23b83ad](https://github.com/gorkking/deepagents/commit/23b83ad50f63d241d0069a3dc426d43b211adf2e))
* **code:** add `google_anthropic_vertex` provider for Claude on Vertex AI ([#5760](https://github.com/gorkking/deepagents/issues/5760)) ([aa69916](https://github.com/gorkking/deepagents/commit/aa69916baf74c904a70a7497f78752d294df82ac))
* **code:** add `GPT-6 Astra` support ([#6141](https://github.com/gorkking/deepagents/issues/6141)) ([048f989](https://github.com/gorkking/deepagents/commit/048f9890bfe8b640e1e72085a4fa50d9084545f0))
* **code:** add `multi_select` question type to `ask_user` ([#5097](https://github.com/gorkking/deepagents/issues/5097)) ([878ab3e](https://github.com/gorkking/deepagents/commit/878ab3e20d35de63001476d5e68c29b12fad4f12))
* **code:** add Baseten `zai-org/GLM-5.3-Flash` to model switcher ([#5844](https://github.com/gorkking/deepagents/issues/5844)) ([731d2d5](https://github.com/gorkking/deepagents/commit/731d2d5a56dc0f9e78cec77722af592ad939edd3))
* **code:** add cache and context status row ([#5408](https://github.com/gorkking/deepagents/issues/5408)) ([2b3edf9](https://github.com/gorkking/deepagents/commit/2b3edf9ba4f3b43911f118b8e942374091602854))
* **code:** add extension trust and inspection UX ([#5634](https://github.com/gorkking/deepagents/issues/5634)) ([da5dcdc](https://github.com/gorkking/deepagents/commit/da5dcdc1df38218f50d57be37908bc39438e3f2b))
* **code:** add Meta `muse-spark-1.2` to model switcher ([#5389](https://github.com/gorkking/deepagents/issues/5389)) ([922b285](https://github.com/gorkking/deepagents/commit/922b285598be3b2ca6b3ec01e7362e31ad2014b2))
* **code:** add OpenRouter `z-ai/glm-5.3` to model switcher ([#5641](https://github.com/gorkking/deepagents/issues/5641)) ([6295924](https://github.com/gorkking/deepagents/commit/6295924d428fb061945cd83940c47c765091353b))
* **code:** add optional extra uninstall commands ([#5875](https://github.com/gorkking/deepagents/issues/5875)) ([d36f226](https://github.com/gorkking/deepagents/commit/d36f22694d4b5d9ac9fa806292389954861cd53b))
* **code:** attribute skill invocations in trace metadata ([#5925](https://github.com/gorkking/deepagents/issues/5925)) ([68fa627](https://github.com/gorkking/deepagents/commit/68fa627522e60fe5d5278b454d21fa63a40b2d35))
* **code:** auto-update installed plugins ([#5368](https://github.com/gorkking/deepagents/issues/5368)) ([3bf6ca7](https://github.com/gorkking/deepagents/commit/3bf6ca7ac076bc0330b65d244e3b46f398674de8))
* **code:** bind conversations to a recorded workspace ([#5946](https://github.com/gorkking/deepagents/issues/5946)) ([4ca758e](https://github.com/gorkking/deepagents/commit/4ca758ed8efd9b586b26685bc3dc787501f3d502))
* **code:** carry `TERM_PROGRAM` into the resume hint ([#5548](https://github.com/gorkking/deepagents/issues/5548)) ([3cdc821](https://github.com/gorkking/deepagents/commit/3cdc82181bc94a904290cce23db04d8a1341b123))
* **code:** CLI config provider ([#5774](https://github.com/gorkking/deepagents/issues/5774)) ([951a1cf](https://github.com/gorkking/deepagents/commit/951a1cf54b9fa373f1853685b21a084512ab2937))
* **code:** configure and load Python extensions ([#5632](https://github.com/gorkking/deepagents/issues/5632)) ([017d7ae](https://github.com/gorkking/deepagents/commit/017d7ae41fe1dfe3fe7fa07bfa206959170707ed))
* **code:** confirm model switches with large context ([#5829](https://github.com/gorkking/deepagents/issues/5829)) ([acc3d33](https://github.com/gorkking/deepagents/commit/acc3d33f357c027ec298bf7682d407a15249e706))
* **code:** copy current model from picker header ([#5904](https://github.com/gorkking/deepagents/issues/5904)) ([cfd9e7a](https://github.com/gorkking/deepagents/commit/cfd9e7aedfd4438d284bf5b567dbc858936af2e4))
* **code:** default Auto classifier by provider ([#6039](https://github.com/gorkking/deepagents/issues/6039)) ([99ed6c8](https://github.com/gorkking/deepagents/commit/99ed6c83238851eb334e19b27d3faec8869fc9a7))
* **code:** default general-purpose subagents to fork mode ([#6024](https://github.com/gorkking/deepagents/issues/6024)) ([d3ad134](https://github.com/gorkking/deepagents/commit/d3ad134a49287d80b9897b0ef38b4635f8d7de94))
* **code:** default the stale editable-deps prompt to `Refresh environment now` ([#5810](https://github.com/gorkking/deepagents/issues/5810)) ([de60958](https://github.com/gorkking/deepagents/commit/de60958a7d79bd4f63b678e8b4e3f02230060879))
* **code:** define and discover Python extensions ([#5631](https://github.com/gorkking/deepagents/issues/5631)) ([738bf07](https://github.com/gorkking/deepagents/commit/738bf077f8b079164f11742bfcaa2fa93df138d7))
* **code:** enable secret redaction by default ([#5816](https://github.com/gorkking/deepagents/issues/5816)) ([fd7d268](https://github.com/gorkking/deepagents/commit/fd7d2682271cc36180f361f89d1a69557637a03f))
* **code:** encode multi-select `ask_user` answers as JSON arrays ([#5660](https://github.com/gorkking/deepagents/issues/5660)) ([fc70294](https://github.com/gorkking/deepagents/commit/fc70294bcf9ac134c21646bcbe8546aab001442d))
* **code:** enforce configured model allowlists ([#5649](https://github.com/gorkking/deepagents/issues/5649)) ([dd8b8ad](https://github.com/gorkking/deepagents/commit/dd8b8ad84aab54dfe1da4a277dfa9539a03e645c))
* **code:** gate `TERM_PROGRAM` resume hints ([#5580](https://github.com/gorkking/deepagents/issues/5580)) ([e8035e7](https://github.com/gorkking/deepagents/commit/e8035e78e8be9d1edfe9a131bcc0df12349f754d))
* **code:** highlight shell commands in the chat input ([#5675](https://github.com/gorkking/deepagents/issues/5675)) ([d711bc6](https://github.com/gorkking/deepagents/commit/d711bc61300090181dc89e3e116e8b343fb65425))
* **code:** host Python extensions in the agent runtime ([#5633](https://github.com/gorkking/deepagents/issues/5633)) ([2c8d154](https://github.com/gorkking/deepagents/commit/2c8d154c7616071919cab4947403dff701e74b31))
* **code:** link doctor commit hash to GitHub ([#5920](https://github.com/gorkking/deepagents/issues/5920)) ([c9e6f55](https://github.com/gorkking/deepagents/commit/c9e6f55c3ee4b6efedfc945fd1c9b160e6e2a872))
* **code:** list MCP servers needing login ([#5867](https://github.com/gorkking/deepagents/issues/5867)) ([a71cafd](https://github.com/gorkking/deepagents/commit/a71cafdbbd851db65dc311eebe5574982866b222))
* **code:** load managed config from a remote source ([#5776](https://github.com/gorkking/deepagents/issues/5776)) ([9f3a1dd](https://github.com/gorkking/deepagents/commit/9f3a1dd38f8b5dbd828d2f366e9b03dad359fadf))
* **code:** make `/offload` server-owned ([#5261](https://github.com/gorkking/deepagents/issues/5261)) ([b494f43](https://github.com/gorkking/deepagents/commit/b494f43437de3569c8c512d65f5f3accda8e0730))
* **code:** make project `.env` loading configurable ([#5726](https://github.com/gorkking/deepagents/issues/5726)) ([995cad6](https://github.com/gorkking/deepagents/commit/995cad67519af294851282133f8c40f643807c88))
* **code:** make teardown usage stats configurable ([#5696](https://github.com/gorkking/deepagents/issues/5696)) ([c1d965a](https://github.com/gorkking/deepagents/commit/c1d965aa0db93f923ec17947fab34a5300c19141))
* **code:** model-node retry middleware for transient model errors ([#4569](https://github.com/gorkking/deepagents/issues/4569)) ([948fea8](https://github.com/gorkking/deepagents/commit/948fea88e2c1e0660a3c1c7a077121c573f11675))
* **code:** open footer pickers on click ([#5674](https://github.com/gorkking/deepagents/issues/5674)) ([4f65325](https://github.com/gorkking/deepagents/commit/4f65325ed322ce1c650152b31532b219bfa3850c))
* **code:** open footer pickers with `ctrl+click` ([#5611](https://github.com/gorkking/deepagents/issues/5611)) ([ee339fb](https://github.com/gorkking/deepagents/commit/ee339fb8c39a1432f0cc12c181431c60b4e235f9))
* **code:** open summarization model picker ([#5932](https://github.com/gorkking/deepagents/issues/5932)) ([f90d4fe](https://github.com/gorkking/deepagents/commit/f90d4fe114efe1de1e3d8dd8e5aee5b9f631093d))
* **code:** optionally show visible reasoning ([#5887](https://github.com/gorkking/deepagents/issues/5887)) ([457ac43](https://github.com/gorkking/deepagents/commit/457ac435e1216d3f7cac76d4e856b7aa020b5ea8))
* **code:** persist and reconfigure ACP sessions ([#5366](https://github.com/gorkking/deepagents/issues/5366)) ([22a36d2](https://github.com/gorkking/deepagents/commit/22a36d25d9e82902fa28cdacdcb51cd6a9b013d7))
* **code:** personalize external editor hints ([#5445](https://github.com/gorkking/deepagents/issues/5445)) ([b72b3dd](https://github.com/gorkking/deepagents/commit/b72b3dd72e0a31962ebf19261dba547462b4e394))
* **code:** prompt clipboard ([#5733](https://github.com/gorkking/deepagents/issues/5733)) ([c2f44ff](https://github.com/gorkking/deepagents/commit/c2f44ffd2759401a5ba31b5f7c41a12b441d6663))
* **code:** quieter diff hunks with word-level highlights ([#5106](https://github.com/gorkking/deepagents/issues/5106)) ([529f7e8](https://github.com/gorkking/deepagents/commit/529f7e8a16c7441873a305a9fa36c2721fa7a5b7))
* **code:** re-auth MCP servers from viewer ([#5637](https://github.com/gorkking/deepagents/issues/5637)) ([d7c24d8](https://github.com/gorkking/deepagents/commit/d7c24d85f7b4d478116f022e1e969ddac89aeb2f))
* **code:** replace Gemini 3.6 Flash with 3.7 Flash ([#5681](https://github.com/gorkking/deepagents/issues/5681)) ([9446182](https://github.com/gorkking/deepagents/commit/94461821d8d7e1ef1f1cd29bc0212c731c195ae5))
* **code:** resize chat input by dragging its top border ([#5524](https://github.com/gorkking/deepagents/issues/5524)) ([d01e4ac](https://github.com/gorkking/deepagents/commit/d01e4ac5bf36752e5c89c1c6645d486282cb611f))
* **code:** show Auto approval review progress ([#5729](https://github.com/gorkking/deepagents/issues/5729)) ([8fe11f0](https://github.com/gorkking/deepagents/commit/8fe11f0c2566d95b0ca9af6db9ade7a4c58753e6))
* **code:** show cached updates in version output ([#5817](https://github.com/gorkking/deepagents/issues/5817)) ([b6a7792](https://github.com/gorkking/deepagents/commit/b6a77921ceafbe5b6db576e62b5f3f1609e4ebe9))
* **code:** show conversation turns alongside message counts ([#5571](https://github.com/gorkking/deepagents/issues/5571)) ([3dd4fe5](https://github.com/gorkking/deepagents/commit/3dd4fe5cdc548f5408d5b74b82084d9d4c01a664))
* **code:** show Escape hint in model picker ([#5775](https://github.com/gorkking/deepagents/issues/5775)) ([a103a88](https://github.com/gorkking/deepagents/commit/a103a88f8a93ef318d64fa9e3bcdd2007cf7a45c))
* **code:** standardize external editor shortcut ([#5911](https://github.com/gorkking/deepagents/issues/5911)) ([f75300f](https://github.com/gorkking/deepagents/commit/f75300f12dc363132dc187e674cf3cd52eb93595))
* **code:** suggest compacting large resumed threads ([#5318](https://github.com/gorkking/deepagents/issues/5318)) ([cb2329d](https://github.com/gorkking/deepagents/commit/cb2329d1ec480455a7ba4e2b277cbd727c9215c7))
* **code:** support `DEEPAGENTS_HOME` ([#5773](https://github.com/gorkking/deepagents/issues/5773)) ([feb5736](https://github.com/gorkking/deepagents/commit/feb5736dfb7309008674020442c943ac3e2dc19d))
* **code:** support ACP approval modes ([#5394](https://github.com/gorkking/deepagents/issues/5394)) ([7772a14](https://github.com/gorkking/deepagents/commit/7772a1495440739130b8b613aa69433fbc0afbad))
* **code:** toggle diff line numbers ([#5427](https://github.com/gorkking/deepagents/issues/5427)) ([4cd21b6](https://github.com/gorkking/deepagents/commit/4cd21b61592ef0239f59cf4e3f27a2a70d226737))
* **code:** trace effective approval mode ([#5972](https://github.com/gorkking/deepagents/issues/5972)) ([c56958d](https://github.com/gorkking/deepagents/commit/c56958d633cd9513ba699f940d4fadfee6cd3963))
* **code:** trust user-declared endpoints for cold-cache policies ([#5462](https://github.com/gorkking/deepagents/issues/5462)) ([107980e](https://github.com/gorkking/deepagents/commit/107980e387b3fa060c2b33e9bd31b57c387eddb6))
* **code:** unify notification center and settings ([#5698](https://github.com/gorkking/deepagents/issues/5698)) ([9767f42](https://github.com/gorkking/deepagents/commit/9767f420c622a31a7511c4601739534ddc6062a7))
* **code:** warn above configurable session cost threshold ([#5405](https://github.com/gorkking/deepagents/issues/5405)) ([8cf8517](https://github.com/gorkking/deepagents/commit/8cf8517e7fb728fedd07db15a0577b305cd69f70))
* **code:** warn before expensive cold-cache turns ([#5439](https://github.com/gorkking/deepagents/issues/5439)) ([8d2298f](https://github.com/gorkking/deepagents/commit/8d2298ff54797e224233349e4baf68e19b110040))


### Bug Fixes

* **code,evals:** allow instrumental Auto actions ([#5832](https://github.com/gorkking/deepagents/issues/5832)) ([56f51d8](https://github.com/gorkking/deepagents/commit/56f51d83a7d6621f2c3954ce69740c46e3cc1426))
* **code:** accept bare relative paths in marketplace plugin sources ([#5959](https://github.com/gorkking/deepagents/issues/5959)) ([28468d6](https://github.com/gorkking/deepagents/commit/28468d62f208e3dea5a574898d19e7d9618db928))
* **code:** align wrapped debug snapshot values ([#5727](https://github.com/gorkking/deepagents/issues/5727)) ([1f74959](https://github.com/gorkking/deepagents/commit/1f7495949232fe2e3e3328b6ff9054c202002f95))
* **code:** always restart after a successful startup auto-update ([#5317](https://github.com/gorkking/deepagents/issues/5317)) ([8cdee15](https://github.com/gorkking/deepagents/commit/8cdee15bbc54381229a686f8263656be0202b9b5))
* **code:** append refreshed local context after compaction ([#5828](https://github.com/gorkking/deepagents/issues/5828)) ([3a78de7](https://github.com/gorkking/deepagents/commit/3a78de7c3feeea4bc180e91003f6a43ee1a29064))
* **code:** avoid detached spacer mount anchors ([#5516](https://github.com/gorkking/deepagents/issues/5516)) ([a38dc42](https://github.com/gorkking/deepagents/commit/a38dc4297b225e424207df5efd7dec0cf38ce832))
* **code:** avoid duplicate Auto denial notices ([#5501](https://github.com/gorkking/deepagents/issues/5501)) ([41395c5](https://github.com/gorkking/deepagents/commit/41395c586d9743550c27073260539724a4bfedd3))
* **code:** avoid plugin reload prompt flash ([#5500](https://github.com/gorkking/deepagents/issues/5500)) ([e03f030](https://github.com/gorkking/deepagents/commit/e03f03026984bf4bdeb8bd661707f29a4d682738))
* **code:** avoid transcript hydration lag ([#5479](https://github.com/gorkking/deepagents/issues/5479)) ([3c8cae6](https://github.com/gorkking/deepagents/commit/3c8cae6fa44d4e12062fdb10421b48587925eade))
* **code:** bind Auto-mode "yes" to the paired `ask_user` question ([#5038](https://github.com/gorkking/deepagents/issues/5038)) ([f4f138d](https://github.com/gorkking/deepagents/commit/f4f138db65484d4938ef3759cb26cec1e789357d))
* **code:** bind request-time working directories ([#5968](https://github.com/gorkking/deepagents/issues/5968)) ([98db566](https://github.com/gorkking/deepagents/commit/98db566f2cc654a535ed68de4dbdd2e10a2edd30))
* **code:** block dotenv git config injection keys ([#5723](https://github.com/gorkking/deepagents/issues/5723)) ([328f916](https://github.com/gorkking/deepagents/commit/328f9160e0f95a459be8ad57f76e7178b24a3ef8))
* **code:** bound transcript tail reconciliation ([#6057](https://github.com/gorkking/deepagents/issues/6057)) ([8da3264](https://github.com/gorkking/deepagents/commit/8da32644dc7dcad1125a840bc17ec3d5ea66b8c3))
* **code:** cap MCP tool names for provider compatibility ([#5953](https://github.com/gorkking/deepagents/issues/5953)) ([0eb8e57](https://github.com/gorkking/deepagents/commit/0eb8e578708a18c3a789f76c4bb13d92bd768192))
* **code:** capture stdio MCP server stderr into the logger ([#5610](https://github.com/gorkking/deepagents/issues/5610)) ([a61bc6f](https://github.com/gorkking/deepagents/commit/a61bc6feeb6aefd780ad8435acc9ce2057fe9151))
* **code:** clarify auth environment setup ([#5767](https://github.com/gorkking/deepagents/issues/5767)) ([a095af9](https://github.com/gorkking/deepagents/commit/a095af93cf3e8ef0c06d9958cfca52dfe9230fcb))
* **code:** clarify Auto mode file-edit example ([#5685](https://github.com/gorkking/deepagents/issues/5685)) ([50dedf0](https://github.com/gorkking/deepagents/commit/50dedf086bb923ec71f585d907ac3920d0442754))
* **code:** clarify clear command descriptions ([#5841](https://github.com/gorkking/deepagents/issues/5841)) ([a6b069d](https://github.com/gorkking/deepagents/commit/a6b069db380c5483c414f48d9b57899c749c8528))
* **code:** clarify dependency warning prompt ([#5489](https://github.com/gorkking/deepagents/issues/5489)) ([31e4941](https://github.com/gorkking/deepagents/commit/31e49418c7538542ff30b2701cf8ac9d1182bbeb))
* **code:** clarify line number toggle message ([#5694](https://github.com/gorkking/deepagents/issues/5694)) ([bb75e96](https://github.com/gorkking/deepagents/commit/bb75e96192f30ffccb193f2ccdc349a0227ca1af))
* **code:** clarify project hooks trust prompt and stop prompting for user hooks ([#5426](https://github.com/gorkking/deepagents/issues/5426)) ([61d3279](https://github.com/gorkking/deepagents/commit/61d32797ef85d1380e356cd2f9de1eb7926417ec))
* **code:** clear dynamic subagents on next turn ([#5437](https://github.com/gorkking/deepagents/issues/5437)) ([9a37479](https://github.com/gorkking/deepagents/commit/9a37479f866160f92474847720b57db9598ddb3e))
* **code:** collapse resized chat input on double-click ([#5578](https://github.com/gorkking/deepagents/issues/5578)) ([fdde617](https://github.com/gorkking/deepagents/commit/fdde617eb590191162a1ebbd9a5fb6c2763ee462))
* **code:** complete ASCII UI fallbacks ([#5930](https://github.com/gorkking/deepagents/issues/5930)) ([e9a1623](https://github.com/gorkking/deepagents/commit/e9a16234f14ea570e04a936cf8070156d01eae99))
* **code:** complete the `dcode config` surface ([#5581](https://github.com/gorkking/deepagents/issues/5581)) ([84eb09d](https://github.com/gorkking/deepagents/commit/84eb09d8edaa52297ca3e2ad76a2c85a9adf4130))
* **code:** condition relative timestamp toggle ([#5503](https://github.com/gorkking/deepagents/issues/5503)) ([96d72a1](https://github.com/gorkking/deepagents/commit/96d72a188bf951c9d3ca103e6611dcb50961af93))
* **code:** count distinct targets in grouped tool summaries ([#5409](https://github.com/gorkking/deepagents/issues/5409)) ([cf8ea93](https://github.com/gorkking/deepagents/commit/cf8ea93a634b2ae03fa9033db6e0e240ed2ae1a1))
* **code:** defer plugin reload hint during startup ([#5502](https://github.com/gorkking/deepagents/issues/5502)) ([dc029ef](https://github.com/gorkking/deepagents/commit/dc029ef5072e9114125e4d332d3631dc1c3d4883))
* **code:** defer the recursion limit to the LangGraph server ([#5882](https://github.com/gorkking/deepagents/issues/5882)) ([4379a46](https://github.com/gorkking/deepagents/commit/4379a463a181a978aab206e93cdcc0788f7eac2b))
* **code:** disable Git terminal prompts in `execute` ([#5878](https://github.com/gorkking/deepagents/issues/5878)) ([a535b61](https://github.com/gorkking/deepagents/commit/a535b610a158a79a2629fac73fa788d7b31f4096))
* **code:** drain hook pipes after timeout ([#5606](https://github.com/gorkking/deepagents/issues/5606)) ([575a8ac](https://github.com/gorkking/deepagents/commit/575a8acb0307bbea9e08f4f8c15d850580a55cb3))
* **code:** drop `Muse Spark 1.1` recommendation ([#5683](https://github.com/gorkking/deepagents/issues/5683)) ([fa2e8ab](https://github.com/gorkking/deepagents/commit/fa2e8abb4da1f07163cb5ee3daff4d57ea97fe9f))
* **code:** drop the "Message restored to input" toast ([#5253](https://github.com/gorkking/deepagents/issues/5253)) ([c206eb4](https://github.com/gorkking/deepagents/commit/c206eb450d612f77924ee55ecd136fbc52f459ab))
* **code:** ensure rubric coverage ([#5369](https://github.com/gorkking/deepagents/issues/5369)) ([442933d](https://github.com/gorkking/deepagents/commit/442933da662d4497a29558f889ca972cd36b5488))
* **code:** extend text selection with `Shift` + `click` ([#5732](https://github.com/gorkking/deepagents/issues/5732)) ([e05931b](https://github.com/gorkking/deepagents/commit/e05931b3016ed3d1500df0c5b77402f457ee5686))
* **code:** flush traces before server shutdown ([#5837](https://github.com/gorkking/deepagents/issues/5837)) ([804fdcc](https://github.com/gorkking/deepagents/commit/804fdcc436538686ca345965c0511e0664eb7c34))
* **code:** group resume trace rounds ([#5593](https://github.com/gorkking/deepagents/issues/5593)) ([345859e](https://github.com/gorkking/deepagents/commit/345859e8e13d5b48348efebd0a48bfb4d3fbf132))
* **code:** guard path expansion in the Auto approval gate ([#5941](https://github.com/gorkking/deepagents/issues/5941)) ([46dea07](https://github.com/gorkking/deepagents/commit/46dea076a77f2b580829b5a211469c68b8924f2a))
* **code:** hide chat input cursor while unfocused ([#5258](https://github.com/gorkking/deepagents/issues/5258)) ([c66d9b8](https://github.com/gorkking/deepagents/commit/c66d9b8500f120d6552af258750da8bb0dede7b8))
* **code:** hide dependency details after updates ([#5519](https://github.com/gorkking/deepagents/issues/5519)) ([cf7578d](https://github.com/gorkking/deepagents/commit/cf7578d1c3403bde960a43cba51f5dad7c336cb3))
* **code:** hide empty previous-thread hints ([#5552](https://github.com/gorkking/deepagents/issues/5552)) ([0f5bd4f](https://github.com/gorkking/deepagents/commit/0f5bd4f3356d0fcbdea436a27c8011629416a61c))
* **code:** hide inactive F2 tool hint ([#5939](https://github.com/gorkking/deepagents/issues/5939)) ([fd7ba1a](https://github.com/gorkking/deepagents/commit/fd7ba1ac47e9afbf7a60a40010f72130ff47ee25))
* **code:** hide incomplete extras from version output ([#5352](https://github.com/gorkking/deepagents/issues/5352)) ([38f32cd](https://github.com/gorkking/deepagents/commit/38f32cdbfdfcf1728178dbee85a42751dd3f3d2e))
* **code:** hide invalid cache metrics ([#5475](https://github.com/gorkking/deepagents/issues/5475)) ([33a57cb](https://github.com/gorkking/deepagents/commit/33a57cbe6808e3da5f4067b7567f77845578ff61))
* **code:** hide MCP token path outside debug mode ([#5866](https://github.com/gorkking/deepagents/issues/5866)) ([bd79104](https://github.com/gorkking/deepagents/commit/bd791048b3dfafae3df81e89aa81388e26bc9667))
* **code:** hide onboarding Tavily cancel hint ([#5684](https://github.com/gorkking/deepagents/issues/5684)) ([b91da61](https://github.com/gorkking/deepagents/commit/b91da61716253dbcf1805c6dede589ec41a09ec5))
* **code:** hide startup tips when resuming threads ([#5349](https://github.com/gorkking/deepagents/issues/5349)) ([ff421f2](https://github.com/gorkking/deepagents/commit/ff421f2f316f3819d8ac92225ea032dabfbcefe9))
* **code:** hide thread IDs when tracing is disabled ([#5692](https://github.com/gorkking/deepagents/issues/5692)) ([1680237](https://github.com/gorkking/deepagents/commit/1680237e69bf27740001df7a7f67de5a053536c1))
* **code:** increase warm limit to 800 ([#5728](https://github.com/gorkking/deepagents/issues/5728)) ([f954cde](https://github.com/gorkking/deepagents/commit/f954cde37f1171adc2ec3f1516a0393bded47e82))
* **code:** indent wrapped ask-user choices and add selection styling ([#5442](https://github.com/gorkking/deepagents/issues/5442)) ([a78d7b1](https://github.com/gorkking/deepagents/commit/a78d7b1744050c3221aab5e0c0300cc5f5bec519))
* **code:** isolate debug logs by thread ([#5921](https://github.com/gorkking/deepagents/issues/5921)) ([4358cce](https://github.com/gorkking/deepagents/commit/4358ccee79dc9350600af02e4e52633b919d7382))
* **code:** isolate parallel `task` failures ([#5954](https://github.com/gorkking/deepagents/issues/5954)) ([e0a474f](https://github.com/gorkking/deepagents/commit/e0a474fed575992abc991f6a8049cc8e18e328c0))
* **code:** keep chat input responsive during `/reload` ([#5529](https://github.com/gorkking/deepagents/issues/5529)) ([5aa266e](https://github.com/gorkking/deepagents/commit/5aa266eab5ca0aedee58367c63599a926863d2cf))
* **code:** keep installed providers visible in `/auth` ([#5689](https://github.com/gorkking/deepagents/issues/5689)) ([f0854e8](https://github.com/gorkking/deepagents/commit/f0854e82ed8cedd8a8455539eef596d1433eb68e))
* **code:** keep long thread resumes responsive ([#5772](https://github.com/gorkking/deepagents/issues/5772)) ([85e1e5b](https://github.com/gorkking/deepagents/commit/85e1e5b130b7501308e7e57d0be389f41f5b72df))
* **code:** keep MCP shutdown-race traceback off the terminal ([#5325](https://github.com/gorkking/deepagents/issues/5325)) ([7d97097](https://github.com/gorkking/deepagents/commit/7d9709700dd24cc2477cd091f01de990f23ee4a9))
* **code:** keep rapid typing visible ([#5424](https://github.com/gorkking/deepagents/issues/5424)) ([6a7c7d6](https://github.com/gorkking/deepagents/commit/6a7c7d6575915dbc4b1549133735f50666919979))
* **code:** let MCP footer wrap on narrow windows ([#5651](https://github.com/gorkking/deepagents/issues/5651)) ([d00926e](https://github.com/gorkking/deepagents/commit/d00926e9e0278d6e74f91622b00d1375c7af19ab))
* **code:** make `/offload` interruptible ([#5590](https://github.com/gorkking/deepagents/issues/5590)) ([ab82d48](https://github.com/gorkking/deepagents/commit/ab82d48cc012c5a991660ad53785c2e26030596e))
* **code:** make debug log path click-to-copy ([#5845](https://github.com/gorkking/deepagents/issues/5845)) ([1fc7d1e](https://github.com/gorkking/deepagents/commit/1fc7d1e26d21ff27327b1b0c0a926673c4663001))
* **code:** make prompt clipboard Tab insert ([#5820](https://github.com/gorkking/deepagents/issues/5820)) ([8e03e9c](https://github.com/gorkking/deepagents/commit/8e03e9c37f80a348a14fb87ef875bc2f9b5b3ee9))
* **code:** make tool arg validation errors recoverable ([#5659](https://github.com/gorkking/deepagents/issues/5659)) ([a7027ed](https://github.com/gorkking/deepagents/commit/a7027edc6449e9a7dbf0e082b8747d0999125ca2))
* **code:** move editable path to debug console ([#5850](https://github.com/gorkking/deepagents/issues/5850)) ([e85f4b7](https://github.com/gorkking/deepagents/commit/e85f4b7bd0acc696a3f29f5c298d3353d7d5495f))
* **code:** name models in classifier errors ([#6038](https://github.com/gorkking/deepagents/issues/6038)) ([fff2c77](https://github.com/gorkking/deepagents/commit/fff2c77c755c6d9dce3a6f776a9b94599ad05cfd))
* **code:** offload server config import ([#6089](https://github.com/gorkking/deepagents/issues/6089)) ([90fe4f4](https://github.com/gorkking/deepagents/commit/90fe4f4ac0a1311f1527b1a5cd02bd3ac8664580))
* **code:** omit unavailable web-search prompt guidance ([#5602](https://github.com/gorkking/deepagents/issues/5602)) ([9feaf51](https://github.com/gorkking/deepagents/commit/9feaf51030a30203f43231b7fb9420293be9fedc))
* **code:** only highlight actionable tool rows ([#5769](https://github.com/gorkking/deepagents/issues/5769)) ([b78413c](https://github.com/gorkking/deepagents/commit/b78413c708afae7fba806ae81336007d5d4c0c58))
* **code:** open `/auto model` selector immediately while connecting ([#5341](https://github.com/gorkking/deepagents/issues/5341)) ([72bfc1e](https://github.com/gorkking/deepagents/commit/72bfc1e68574909ceb929be869c66fbdc9fe5a1d))
* **code:** persist Auto approval mode between sessions ([#5665](https://github.com/gorkking/deepagents/issues/5665)) ([3ac059e](https://github.com/gorkking/deepagents/commit/3ac059e1574963fe216692642aa1b1a4044daaa9))
* **code:** point model switch warning to `/offload` ([#5901](https://github.com/gorkking/deepagents/issues/5901)) ([2f4d606](https://github.com/gorkking/deepagents/commit/2f4d606ee338720dd6ae6758761f08c3cb9c2350))
* **code:** preload auth UI before notification handoff ([#5697](https://github.com/gorkking/deepagents/issues/5697)) ([57c0678](https://github.com/gorkking/deepagents/commit/57c0678c4994b8b253c5f7edf11b7a558ece7df9))
* **code:** preserve editables during dependency refresh ([#5521](https://github.com/gorkking/deepagents/issues/5521)) ([f0446c8](https://github.com/gorkking/deepagents/commit/f0446c8c8aecff243545fe0c551a6539ccf482a2))
* **code:** preserve goal notice history for prompt caching ([#5823](https://github.com/gorkking/deepagents/issues/5823)) ([aa8ae71](https://github.com/gorkking/deepagents/commit/aa8ae718644dac19d7f1cdc3febe2740a79fa058))
* **code:** prevent post-tool hook replay ([#5376](https://github.com/gorkking/deepagents/issues/5376)) ([d37b54f](https://github.com/gorkking/deepagents/commit/d37b54f6bfb03f41fc7ff6b05436ad49db688d19))
* **code:** protect TUI from native stderr writes ([#5813](https://github.com/gorkking/deepagents/issues/5813)) ([a4d9b8a](https://github.com/gorkking/deepagents/commit/a4d9b8aa7dfde39f37a4fa40aac8b149e2f66b00))
* **code:** queue `/copy` during active generation ([#5447](https://github.com/gorkking/deepagents/issues/5447)) ([8dfe282](https://github.com/gorkking/deepagents/commit/8dfe282006108dd0c47c50d5a1e3a41558e14723))
* **code:** ranked durable-mask config resolver ([#5672](https://github.com/gorkking/deepagents/issues/5672)) ([9f24b9f](https://github.com/gorkking/deepagents/commit/9f24b9fcaf7ed399b7888b2f0f9d13363939ea87))
* **code:** recognize in-flight trace messages ([#5738](https://github.com/gorkking/deepagents/issues/5738)) ([f1d1f63](https://github.com/gorkking/deepagents/commit/f1d1f632812a85646d25ac2f3d2d7f39b65a0b49))
* **code:** record Auto classifier deadline as a traced error ([#5944](https://github.com/gorkking/deepagents/issues/5944)) ([9a643c7](https://github.com/gorkking/deepagents/commit/9a643c75843a95d3ef770ac69dd1452435596efe))
* **code:** recover stale pending work before compaction ([#5909](https://github.com/gorkking/deepagents/issues/5909)) ([213f0c8](https://github.com/gorkking/deepagents/commit/213f0c8a7dd01febff2a52c9ca0ea61b2cd8fd9d))
* **code:** refresh splash version after update ([#5520](https://github.com/gorkking/deepagents/issues/5520)) ([c2ec5e6](https://github.com/gorkking/deepagents/commit/c2ec5e6d9f85bf114a3666bba982de0c63ec5eb5))
* **code:** refuse a second sandbox workspace ([#5979](https://github.com/gorkking/deepagents/issues/5979)) ([cb4c973](https://github.com/gorkking/deepagents/commit/cb4c973172f7838eefa328ea0c6ca334b6aaab98))
* **code:** reject stale successful updates ([#5847](https://github.com/gorkking/deepagents/issues/5847)) ([23976f4](https://github.com/gorkking/deepagents/commit/23976f414a928eb50d13d351bdc19971098ea7b9))
* **code:** remove notification settings expand flicker and trailing disclosure glyph ([#5734](https://github.com/gorkking/deepagents/issues/5734)) ([5397812](https://github.com/gorkking/deepagents/commit/5397812ad5f217cd84f871f121cf9ea8f3d63f4f))
* **code:** remove optional-provider startup tip ([#5421](https://github.com/gorkking/deepagents/issues/5421)) ([f137897](https://github.com/gorkking/deepagents/commit/f1378978e20f94762601ed38787a6fdb7fb39784))
* **code:** remove review failure approval copy ([#5687](https://github.com/gorkking/deepagents/issues/5687)) ([b6a4146](https://github.com/gorkking/deepagents/commit/b6a41461d1834f673795e39a8928649de142d976))
* **code:** rename OpenAI subscription login label ([#5680](https://github.com/gorkking/deepagents/issues/5680)) ([14b09aa](https://github.com/gorkking/deepagents/commit/14b09aa18567de9325bbf7fa083fe339c90fce0e))
* **code:** render first streamed text immediately ([#5761](https://github.com/gorkking/deepagents/issues/5761)) ([19de73d](https://github.com/gorkking/deepagents/commit/19de73de163d2ca907fa4d9a44f2e19af635aa39))
* **code:** render thread timestamps without the glibc-only `%-I` strftime flag ([#5886](https://github.com/gorkking/deepagents/issues/5886)) ([ef6b5be](https://github.com/gorkking/deepagents/commit/ef6b5beec93bdcbb38ea44f157a029bc07b8b5ee))
* **code:** report MCP server changes on reload ([#5504](https://github.com/gorkking/deepagents/issues/5504)) ([b16a740](https://github.com/gorkking/deepagents/commit/b16a74085af0057a24ce00f23a6a165bf5f21ed2))
* **code:** report total context after `/offload` ([#5488](https://github.com/gorkking/deepagents/issues/5488)) ([5d806c8](https://github.com/gorkking/deepagents/commit/5d806c88cf2a8b10d9b13b832540151491c13e19))
* **code:** resolve message pointer shapes per cell ([#5592](https://github.com/gorkking/deepagents/issues/5592)) ([cd4c399](https://github.com/gorkking/deepagents/commit/cd4c3993faf9aabfc6bb6c22bb56a57c33563106))
* **code:** resolve origin from worktree common Git dir ([#5818](https://github.com/gorkking/deepagents/issues/5818)) ([a8ae714](https://github.com/gorkking/deepagents/commit/a8ae71480f767aac0f0f7cf754ec49e6fd9bf826))
* **code:** respect ASCII mode in splash border ([#5923](https://github.com/gorkking/deepagents/issues/5923)) ([437c2db](https://github.com/gorkking/deepagents/commit/437c2dbbe287c6b37a4fe7466b5f9d5305163d85))
* **code:** restore edit diffs in resumed threads ([#5391](https://github.com/gorkking/deepagents/issues/5391)) ([6a5d93f](https://github.com/gorkking/deepagents/commit/6a5d93f9ba7391189f65e6b999b724253577085d))
* **code:** retry interrupted model streams ([#5905](https://github.com/gorkking/deepagents/issues/5905)) ([dfcd941](https://github.com/gorkking/deepagents/commit/dfcd9417a88c774a232de33e41bb0e69d76ec7ce))
* **code:** say which source path a plugin install rejected ([#5960](https://github.com/gorkking/deepagents/issues/5960)) ([6f8c488](https://github.com/gorkking/deepagents/commit/6f8c48800b02397fd262bfd9caea5096984d4220))
* **code:** scope project dotenv to workspaces ([#5980](https://github.com/gorkking/deepagents/issues/5980)) ([678c115](https://github.com/gorkking/deepagents/commit/678c11559d7534ee5e16ceebfacf01eeb6536ac7))
* **code:** scroll resumed threads to the bottom ([#5543](https://github.com/gorkking/deepagents/issues/5543)) ([1c6d358](https://github.com/gorkking/deepagents/commit/1c6d358c60306aad2af0067dcca76f85f4deeba1))
* **code:** separate YOLO exit hint ([#5688](https://github.com/gorkking/deepagents/issues/5688)) ([5d604ee](https://github.com/gorkking/deepagents/commit/5d604eed6d7ff567bb6c2c3046e385fc8d987698))
* **code:** serialize dcode self-upgrades across processes ([#5252](https://github.com/gorkking/deepagents/issues/5252)) ([e12acba](https://github.com/gorkking/deepagents/commit/e12acbac89e553048b03fb6132b53e61b3433271))
* **code:** shorten Auto classifier selection message ([#5446](https://github.com/gorkking/deepagents/issues/5446)) ([c43919c](https://github.com/gorkking/deepagents/commit/c43919c5c05643d03cf00009339cd0e4d3c17d6d))
* **code:** show Auto first-enable notice as pre-confirmation ([#5686](https://github.com/gorkking/deepagents/issues/5686)) ([32f565f](https://github.com/gorkking/deepagents/commit/32f565f46519d9c35919640bdf9374506d0572d2))
* **code:** show bound workspace in shell approvals ([#5966](https://github.com/gorkking/deepagents/issues/5966)) ([716ab9f](https://github.com/gorkking/deepagents/commit/716ab9fb9c1f27d912aac89a663a75c4861418a5))
* **code:** show contextual auth footer actions ([#5690](https://github.com/gorkking/deepagents/issues/5690)) ([074a501](https://github.com/gorkking/deepagents/commit/074a5019e1f3edfd589614774958400d051e5fe1))
* **code:** show incognito shell command widget ([#5768](https://github.com/gorkking/deepagents/issues/5768)) ([9bef676](https://github.com/gorkking/deepagents/commit/9bef676fe69a3b79c0702fda59b555d1ef6ad3bc))
* **code:** show resume hint after crashes ([#5412](https://github.com/gorkking/deepagents/issues/5412)) ([015a019](https://github.com/gorkking/deepagents/commit/015a0197f588e34475db63c2a03f04987583b081))
* **code:** simplify Auto fallback copy ([#5670](https://github.com/gorkking/deepagents/issues/5670)) ([42afcde](https://github.com/gorkking/deepagents/commit/42afcded97029070f393232778c84aaf3b69fb1c))
* **code:** simplify classifier notice copy ([#5691](https://github.com/gorkking/deepagents/issues/5691)) ([c23c960](https://github.com/gorkking/deepagents/commit/c23c960459e931631842f1a7214b98a2d383f72a))
* **code:** simplify empty `/tokens` message ([#5693](https://github.com/gorkking/deepagents/issues/5693)) ([8a4fc3a](https://github.com/gorkking/deepagents/commit/8a4fc3a3104ab5131bedec0ca1f76289285d5efa))
* **code:** simplify paste expansion toast ([#5443](https://github.com/gorkking/deepagents/issues/5443)) ([217b9eb](https://github.com/gorkking/deepagents/commit/217b9eb372fa51b0439434f31abc3ac22e6cd7f2))
* **code:** skip background sync in Apple Terminal ([#5666](https://github.com/gorkking/deepagents/issues/5666)) ([a2782ff](https://github.com/gorkking/deepagents/commit/a2782ff36efd5e9c9ebd9abb17b6fb51a2f01e8b))
* **code:** skip unchanged config writes ([#5919](https://github.com/gorkking/deepagents/issues/5919)) ([c313ff0](https://github.com/gorkking/deepagents/commit/c313ff0e6b3549d9f959578ae177291d8c8f13a3))
* **code:** skip uncorrelated-result warning for auto-mode policy denials ([#5869](https://github.com/gorkking/deepagents/issues/5869)) ([35fd008](https://github.com/gorkking/deepagents/commit/35fd00833a03e9e76858195aae8b13e7753cfa47))
* **code:** standardize modal navigation hints ([#5699](https://github.com/gorkking/deepagents/issues/5699)) ([85c6833](https://github.com/gorkking/deepagents/commit/85c6833734a547e968221c1199a769d7aac69430))
* **code:** stop passing removed `checkpoint_metadata` ([#5473](https://github.com/gorkking/deepagents/issues/5473)) ([61ae398](https://github.com/gorkking/deepagents/commit/61ae398a60a2f6c23954d89332950570e0b6b431))
* **code:** store update logs under the OS cache dir ([#5363](https://github.com/gorkking/deepagents/issues/5363)) ([f69804b](https://github.com/gorkking/deepagents/commit/f69804bfce2673de4f2171664ac5b91c1c248ea0))
* **code:** stream tool-call args in linear time ([#5712](https://github.com/gorkking/deepagents/issues/5712)) ([57bfa6b](https://github.com/gorkking/deepagents/commit/57bfa6bdc57056265047744dc32f3337a964ddc8))
* **code:** surface stale updates in-session ([#6063](https://github.com/gorkking/deepagents/issues/6063)) ([cdb9d4c](https://github.com/gorkking/deepagents/commit/cdb9d4c30f4419c0eb2c98ad53940875e4dfbe9e))
* **code:** sweep expired history archives at startup ([#5751](https://github.com/gorkking/deepagents/issues/5751)) ([d9dc96e](https://github.com/gorkking/deepagents/commit/d9dc96ed555c94f9973e9b49d4b12fd543038f8b))
* **code:** thread `session_id` through forced-compaction fork ([#5492](https://github.com/gorkking/deepagents/issues/5492)) ([33d323c](https://github.com/gorkking/deepagents/commit/33d323c98bda90c7fe75bcf4a44fb083ed87fa81))
* **code:** track live dynamic subagent cost ([#5833](https://github.com/gorkking/deepagents/issues/5833)) ([37d7777](https://github.com/gorkking/deepagents/commit/37d7777195ff5c30ef789052d02d4387725182b8))
* **code:** update rubric grader model without restart ([#5885](https://github.com/gorkking/deepagents/issues/5885)) ([428e760](https://github.com/gorkking/deepagents/commit/428e760668d8fdfbb920966e2969c76040e30745))
* **code:** use dismissed copy for ask-user prompts ([#5331](https://github.com/gorkking/deepagents/issues/5331)) ([920fb66](https://github.com/gorkking/deepagents/commit/920fb66763e85b759c2ec3cac090bccd7f05b55f))
* **code:** use sharp splash border ([#5970](https://github.com/gorkking/deepagents/issues/5970)) ([096d20c](https://github.com/gorkking/deepagents/commit/096d20cc7f0d61ed027686b226217f4a717925b0))
* **code:** wait for graph readiness after server restart ([#5947](https://github.com/gorkking/deepagents/issues/5947)) ([358bc33](https://github.com/gorkking/deepagents/commit/358bc3347135793afd12b8b387bda94e61bb6f07))
* **code:** warn and ignore `--auto-approve`/`--yolo` in headless mode ([#5750](https://github.com/gorkking/deepagents/issues/5750)) ([9223593](https://github.com/gorkking/deepagents/commit/922359307cb0e7728ab58613b29631500e9c5abc))
* **code:** warn on stale dependencies in editable installs ([#5386](https://github.com/gorkking/deepagents/issues/5386)) ([10353bd](https://github.com/gorkking/deepagents/commit/10353bda7196f307db9b22ef1173764aeda6daa7))


### Performance Improvements

* **code,quickjs:** omit middleware trace inputs ([#6015](https://github.com/gorkking/deepagents/issues/6015)) ([673844d](https://github.com/gorkking/deepagents/commit/673844d06fe0ee186f2e492c3c0a19ec5facffc2))
* **code:** omit middleware trace inputs ([#5815](https://github.com/gorkking/deepagents/issues/5815)) ([39b760f](https://github.com/gorkking/deepagents/commit/39b760f12452e1b04bcd0fa15850662ce83ceee8))
